...
"C:\Program Files\OpenSCAD\openscad.exe" -D"npart=5" -o m2m.stl roboparts.scad
"C:\Program Files\OpenSCAD\openscad.exe" -D"npart=10" -o servoSleeve.stl roboparts.scad
"C:\Program Files\OpenSCAD\openscad.exe" -D"npart=15" -o servoSleeveWithConnectors.stl roboparts.scad
